...
var TicTacToe = {
    ...
    setTurnIndicator: function() {
        this.turnIndicator.innerText = this.symbols[this.activePlayer] + " turn"
    },
    ...
    play: function(el) {
        ...
        if (!this.gameOver && el.classList.length == 1) {
            ...
            // check if there is a draw egalité 
            else if (this.checkDraw()) {
                // set the game text to say nobody won
                this.turnIndicator.innerText = "nobody won";
                // call the game over function
                this.endGame();
            }
    ...
    // check if there is a draw match nul 
    checkDraw: function() {
